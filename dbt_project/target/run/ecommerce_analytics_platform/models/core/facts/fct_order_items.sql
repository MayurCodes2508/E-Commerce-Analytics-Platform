    ...
    create or replace table `intense-pixel-490219-h2`.`dev_core`.`fct_order_items`
...
JOIN `intense-pixel-490219-h2`.`dev_core`.`fct_orders` o
...
FROM base b
JOIN `intense-pixel-490219-h2`.`dev_core`.`dim_date` dd_order_item_created_at
